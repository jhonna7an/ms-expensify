...
{
    public class TransactionCategoriesRepository : BaseRepository<TransactionCategory>, ITransactionCategoriesRepository
    {
        public TransactionCategoriesRepository(IDbContext context) : base(context)
        {
        }
