...
{
    public class TransactionAmountTypesRepository : BaseRepository<TransactionAmountType>, ITransactionAmountTypesRepository
    {
        public TransactionAmountTypesRepository(IDbContext context) : base(context)
        {
        }
