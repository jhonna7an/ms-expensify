...
{
    public class TransactionAccountTypesRepository : BaseRepository<TransactionAccountType>, ITransactionAccountTypesRepository
    {
        public TransactionAccountTypesRepository(IDbContext context) : base(context)
        {
        }
