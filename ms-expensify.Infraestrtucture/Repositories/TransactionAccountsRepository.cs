...
{
    public class TransactionAccountsRepository : BaseRepository<TransactionAccount>, ITransactionAccountsRepository
    {
        public TransactionAccountsRepository(IDbContext context) : base(context)
        {
        }
